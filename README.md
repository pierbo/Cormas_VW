...
VisualWorks compatibility : VW7.6
VERSION : Cormas v.2025.6.14

Visit: [https://vw.cormas.org](https://vw.cormas.org/indexeng.htm)

A new version of Cormas is now available on Pharo: https://cormas.org 


Thank 's to the following contributors: 
Innocent Bakam
François Bousquet
Christophe Le Page
Pierre Bommel
